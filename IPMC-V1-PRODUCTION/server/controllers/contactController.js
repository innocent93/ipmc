...
exports.submitContact = async (req, res) => {
  try {
    ...
    // auto-fills every input trips it — respond with the same success
    // shape a real submission gets (never save it, never email anyone),
    // so the bot has no signal to adapt against.
    if (req.body.website) {
