...
const { getAllServices, getAllServicesAdmin, getServiceBySlug, createService, updateService, deleteService } = require('../controllers/serviceController');
const { authenticate, authorize } = require('../middleware/auth');
const { validate, schemas } = require('../middleware/validation');

router.get('/', getAllServices);
router.get('/admin/all', authenticate, authorize('admin', 'editor'), getAllServicesAdmin);
